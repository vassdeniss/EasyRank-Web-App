...
namespace EasyRank.Infrastructure.Data.Migrations
{
    ...
    [Migration("20221001210508_AddedContentToCommentTable")]
    partial class AddedContentToCommentTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyRank.Infrastructure.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Gets or sets the unique GUID identifier for a user.");

                    b.Property<string>("Email")
                        .IsRequired()
                        .HasMaxLength(320)
                        .HasColumnType("nvarchar(320)")
                        .HasComment("Gets or sets the unique email for a user.");
                    ...
                    b.Property<string>("Username")
                        ...
                        .HasComment("Gets or sets the unique username for a user.");

                    b.HasKey("Id");

                    b.ToTable("Users");

                    b.HasComment("The 'user' model for the database.");
                });
            ...
            modelBuilder.Entity("EasyRank.Infrastructure.Models.Comment", b =>
                {
                    b.HasOne("EasyRank.Infrastructure.Models.User", "CreatedByUser")
                        .WithMany()
